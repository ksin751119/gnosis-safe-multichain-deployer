...
├── gnosis_safe_multichain_deployer             # The main python package for the project
...
e.g: `cat gnosis_safe_multichain_deployer/VERSION` will get the project version without harming
